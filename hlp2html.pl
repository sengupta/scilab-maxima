...
# sous-réprtoires 'macros' et 'html' d'une toolbox Scilab et exécuter
# 'perl hlp2html.pl'. Attention, les fichiers du sous-répertoire 'html'
...
# // de 68 caractères on peur aussi utiliser la balise HTML <br>. Les
# // balises ne seront pas affichées en utilisant 'hlp foo'. Ne pas
# // utiliser '<string>' qui serait considéré comme une balise HTML
# // inconnue.
# //
# // REMARK(S) (facultatif)
# // Comme ci-dessus.
...
# Fabrication de l'index
   ...
   foreach $f (@FUNC) {
      $index_html .= "<li><a class=\"function\" href=\"$f.html\">$f</a></li>\n";
   }
   $index_html .= "</ul>\n\n</td></tr></table></center>\n\n</body>\n";
   ...
   open(filehtml,">html/index.html") || die "Ouverture impossible";
...
# DEBUT et FIN du fichier HTML
   ...
   $debut .= "<link rel='stylesheet' href='brown.css'>\n";
   $debut .= "</head>\n";
   $debut .= "<body bgcolor='#FFFFFF' text='#000000'>\n\n";
   $debut .= "<center><table class=\"bod\"><tr><td>\n\n";
   $debut .= "<table class=\"button\"><tr><td class=\"button\"><a href=\"index.html\">FUNCTIONS</a></td></tr></table>\n\n";
   $debut .= "<p><h1>Function: $NOMFONC</h1></p>\n\n";
...
# Traitement de $SYNOP (en premier car on y identifie les arguments)
   ...
   for ($j = 0; $j <= $#synop2; $j++) {
      ...
      if ($NOMFONC2){
         ...
         $synop2[$j] = "[$1] = <tt class=\"function\">$NOMFONC2</tt>($3)";
   ...
   if ($SEEAL){
      ...
      for ($i=0; $i <= $#FUNC0; $i++){
         if ($FUNC0[$i]) {
            ...
            $seeal0 .= "<a href=\"$FUNC0[$i].html\"><tt class=\"function\">$FUNC0[$i]</tt></a>, ";
         }
      };
...
#---------------------------------------------------------------------
   if ($PURPO) {
      $milieu  =  "<p><b>Purpose</b></p>\n\n";
      $milieu .=  "<p>$purpo0</p>\n\n";
   }

   if ($SYNOP) {
      $milieu .=  "<p><b>Synopsis</b></p>\n\n<ul>\n";
      for ($j = 0; $j < $#synop2; $j++) {
         $synop2[$j] =~ s/\[\] = //;
         $milieu .=  "<li><tt>$synop2[$j]</tt></li>\n";
      }
      $milieu .=  "</ul>\n\n";
   }

   if ($DESCR) {
      $milieu .=  "<p><b>Description</b></p>\n\n";
      $milieu .= $descr0;
   }

   if ($REMAR) {
      $milieu .=  "<p><b>Remark</b></p>\n\n";
      $milieu .= $remar0;
   }

   if ($WARNI) {
      $milieu .=  "<p><b>Warning</b></p>\n\n";
      $milieu .= $warni0;
   }

   if ($CAUTI) {
      $milieu .= "<p><b>Caution</b></p>\n\n";
      $milieu .= $cauti0;
   }

   if ($INPUT){
      $milieu .= "<p><b>Input arguments</b></p>\n\n";
      $milieu .= "<p>$input0</p>\n\n";
   };

   if ($OUTPU){
      $milieu .= "<p><b>Output arguments</b></p>\n\n";
      $milieu .= "<p>$outpu0</p>\n\n";
   };
...
#---------------------------------------------------------------------
   ...
   print "Ecriture de $NOMFONC.html dans html\n";
   open(filehtml,">html/$NOMFONC.html") || die "Ouverture impossible";
...
# Fonctions -> classe "function"
   foreach $f (@FUNC) {
      $strArg  =~ s/([\W])$f([\W])/$1<tt class=\"function\">$f<\/tt>$2/g;
      $strArg  =~ s/^$f([\W])/<tt class=\"function\">$f<\/tt>$1/;
   }
...
# Création des cells HTML
   # <tr><td>Premiere cell de gauche</td><td>(Texte cell de droite non modifié)
   $strArg  =~ s/^<tt>([, \w]*?)<\/tt>/<tr><td class=\"args\" width=\"20%\"><tt>$1<\/tt><\/td>\n<td class=\"args\" width=\"80%\">/;
   # </td></tr><tr><td>Cell de gauche</td><td>(Texte cell de droite non modifié)
   $strArg  =~ s/\nBR_BR <tt>([, \w]*?)<\/tt>/<\/td><\/tr>\n\n<tr><td class=\"args\"><tt>$1<\/tt><\/td>\n<td class=\"args\">/g;
   $strArg  =~ s/\n <tt>([, \w]*?)<\/tt>/<\/td><\/tr>\n\n<tr><td class=\"args\"><tt>$1<\/tt><\/td>\n<td class=\"args\">/g;
   # <table> .............</td></tr></table>
   $strArg = "<table border=\"0\" class=\"button\" width=\"100%\">\n\n$strArg</td></tr>\n\n</table>";
